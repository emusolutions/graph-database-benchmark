...
if __name__ == "__main__":
    ...
    parser.add_argument('--test-name', type=str, default="social-network-builder-notouch", help='the name of the test')
    ...
    parser.add_argument('--benchmark-output-file-prefix', type=str, default="social-network-builder-notouch.redisgraph.commands",
                        help='prefix to be used when generating the artifacts')
    parser.add_argument('--benchmark-config-file', type=str, default="social-network-builder-notouch.redisgraph.cfg.json",
